...
print "***Imprimiendo info de duplicados***\n";
print "***Ignorar errores de perl***\n";
...
print "***Eliminando SNPs duplicados***\n";
...
print "***Cambiando codigo de alelos***\n";
